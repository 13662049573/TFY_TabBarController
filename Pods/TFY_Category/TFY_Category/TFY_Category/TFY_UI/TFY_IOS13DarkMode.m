...
#pragma mark - public
- (void)setTraitCollectionChange:(TFY_IOS13DarkMode_MonitorView_TraitCollectionCallback)callback forKey:(NSString *)key forObject:(id)object
{
    NSMutableDictionary *list = [self.callObjectMap objectForKey:object];
    if (list == nil) {
