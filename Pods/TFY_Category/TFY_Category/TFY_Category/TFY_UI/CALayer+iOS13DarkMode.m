...
#import "TFY_iOS13DarkModeTool.h"
#import <UIKit/UIKit.h>
#import <objc/runtime.h>

@interface CALayer (iOS13DarkModePrivate)
...
@interface iOS13DarkModeLayerKVO : NSObject
...
@implementation iOS13DarkModeLayerKVO

- (void)removeKVOSupperLayer:(CALayer *)layer
{
    self.callback = nil;
    if (self.layer && self.layer == layer) {
        [TFY_iOS13DarkModeTool tfy_ExchangeMethodWithOriginalClass:self.class swizzledClass:CALayer.class originalSelector:@selector(tfy_iOS13DarkMode_addSublayer:) swizzledSelector:@selector(addSublayer:)];
        self.layer = nil;
    }
}
...
- (void)addKVOSupperLayer:(CALayer *)layer complete:(tfy_iOS13DarkModeLayerKVOCallback)complete
{
    if (self.layer != layer) {
        ...
        self.layer = layer;
        [TFY_iOS13DarkModeTool tfy_ExchangeMethodWithOriginalClass:layer.class swizzledClass:self.class originalSelector:@selector(addSublayer:) swizzledSelector:@selector(tfy_iOS13DarkMode_addSublayer:)];
    }
...
- (void)tfy_iOS13DarkMode_addSublayer:(CALayer *)layer
{
    ...
    iOS13DarkModeLayerKVO *object = [layer tfy_iOS13KVOSupperLayer];
...
@implementation CALayer (iOS13DarkMode)
...
- (UIView *)tfy_iOS13DarkMode_TopLayerView
{
    ...
    if (!view && ![self tfy_iOS13KVOSupperLayer]) {
        iOS13DarkModeLayerKVO *object = [iOS13DarkModeLayerKVO new];
...
- (void)tfy_setiOS13DarkModeColor:(UIColor *)color forProperty:(NSString *)property withView:(UIView *)contentView {
    ...
    if ([self respondsToSelector:proSetSel]) {
        ...
        if (@available(iOS 13.0, *)) {
            ...
            if (color) {
                [contentView.tfy_iOS13DrakMove_MonitorView setTraitCollectionChange:^(UIView * _Nonnull view) {
...
#pragma clang diagnostic pop
                ...
                [contentView.tfy_iOS13DrakMove_MonitorView setTraitCollectionChange:nil forKey:property forObject:self];
            }
