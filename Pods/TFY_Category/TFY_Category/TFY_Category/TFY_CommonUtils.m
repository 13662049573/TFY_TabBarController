...
@property (strong, nonatomic) TFY_CommonUtils *timer2;
...
+ (TFY_CommonUtils *)scheduledTimerWithTimeInterval:(NSTimeInterval)interval
                                     repeats:(BOOL)repeats
                                       queue:(dispatch_queue_t)queue
                                       block:(void (^)(void))block {
    TFY_CommonUtils *timer = [[TFY_CommonUtils alloc] initWithInterval:interval
                                                 repeats:repeats
                                                   queue:queue
                                                   block:block];
    return timer;
...
- (void)schedule {
    ...
    self.timer2 = [TFY_CommonUtils scheduledTimerWithTimeInterval:self.currentRetryInterval
                                                  repeats:NO
                                                    queue:self.queue
                                                    block:^{
                                                        [weakSelf reconnect];
