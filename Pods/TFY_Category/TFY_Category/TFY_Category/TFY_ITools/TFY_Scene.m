...
- (void)___showInNewWindow{
    ...
    if (showStyle == ControllerShowStylePush) {
        ...
        [root._once(YES) addViewDidAppearBlock:^(UIViewController * _Nonnull vc, BOOL animated) {
...
- (BOOL)__isShowing{
    ...
    [self._once(YES) addViewDidAppearBlock:^(UIViewController * _Nonnull vc, BOOL animated) {
...
- (UIViewController * _Nonnull (^)(BOOL))_once{
    return ^ (BOOL once){
