...
@interface WHGradientHelperGradientTabBarVC ()<TfySY_TabBarDelegate>
...
- (void)addChildViewControllers{
    ...
    self.tfySY_TabBar.backgroundImageView.image = [WHGradientHelper getLinearGradientImage:[UIColor blackColor]
